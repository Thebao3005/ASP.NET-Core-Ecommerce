...
public partial class MuaChungContext : DbContext
{
    public MuaChungContext()
    {
    }

    public MuaChungContext(DbContextOptions<MuaChungContext> options)
        : base(options)
    {
    }
    ...
    public DbSet<ThamGiaMuaChung> ThamGiaMuaChungs { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HangHoa>(entity =>
        {
            ...
            entity.Property(e => e.TenHh)
                .HasMaxLength(50)
                .HasColumnName("TenHH");
            // Thêm thuộc tính IsGiamGia
            entity.Property(e => e.IsGiamGia)
                .HasDefaultValue(false) // Mặc định là false (không giảm giá)
                .HasColumnType("bit")   // Kiểu dữ liệu BIT (true/false)
                .HasColumnName("IsGiamGia");
        ...
        modelBuilder.Entity<HoiDap>(entity =>
        {
            ...
            entity.Property(e => e.MaHdap)
                .ValueGeneratedOnAdd()
                .HasColumnName("MaHD");
            entity.Property(e => e.MaYt) // Mã Yêu Thích (Khóa ngoại)
          .HasColumnName("MaYT");
            ...
            entity.HasOne(e => e.MaYtNavigation)
         .WithMany(y => y.HoiDaps) 
         .HasForeignKey(e => e.MaYt)
         .OnDelete(DeleteBehavior.Cascade) 
         .HasConstraintName("FK_HoiDap_YeuThich");
        });
        ...
        modelBuilder.Entity<YeuThich>(entity =>
        {
            ...
            entity.Property(e => e.SoSao)
                .HasColumnName("SoSao")
                .HasDefaultValue(5); // Mặc định 5 sao
            entity.Property(e => e.AnDanh)
                .HasColumnName("AnDanh")
                .HasDefaultValue(false); // Mặc định không ẩn danh

            // Thiết lập quan hệ với bảng HangHoa (Sản phẩm)
            ...
            // Thiết lập quan hệ với bảng KhachHang (Khách hàng)
            ...
            // 🔥 Thêm quan hệ với bảng HoaDon (Hóa đơn) 
            entity.HasOne(d => d.MaHdNavigation)
                .WithMany(h => h.YeuThiches)
                .HasForeignKey(d => d.MaHd)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_YeuThich_HoaDon");
        });
        modelBuilder.Entity<GiamGia>(entity =>
        {
            entity.HasKey(e => e.MaGG); // Khóa chính

            entity.ToTable("GiamGia"); // Tên bảng trong DB

            entity.Property(e => e.MaGG)
                .ValueGeneratedOnAdd()
                .HasColumnName("MaGG"); // Định danh tự động tăng

            entity.Property(e => e.MaHh)
                .HasColumnName("MaHH")
                .IsRequired(); // Mã hàng hóa bắt buộc

            entity.Property(e => e.TyLeGG)
                .HasColumnName("TyLeGG")
                .IsRequired();

            entity.Property(e => e.NguoiToiThieu)
                .HasColumnName("NguoiToiThieu")
                .IsRequired();
            ...
            entity.Property(e => e.EndTime)
                ...
                .IsRequired();
            entity.Property(e => e.SoNguoiThamGia)
               .HasColumnName("SoNguoiThamGia")
               .IsRequired();
            entity.Property(e => e.IsActive)
                .HasColumnName("IsActive")
                .HasDefaultValue(false); // Mặc định là false (chưa kích hoạt)

            // Liên kết với bảng HangHoa
            entity.HasOne(d => d.HangHoa)
                .WithMany(p => p.GiamGias)
                .HasForeignKey(d => d.MaHh)
                .OnDelete(DeleteBehavior.Cascade) // Nếu sản phẩm bị xóa thì xóa giảm giá
                .HasConstraintName("FK_GiamGia_HangHoa");
        });
        modelBuilder.Entity<ThamGiaMuaChung>(entity =>
        {
            entity.HasKey(e => e.MaThamGia).HasName("PK_ThamGiaMuaChung");

            entity.ToTable("ThamGiaMuaChung");

            entity.Property(e => e.MaThamGia).HasColumnName("MaThamGia");
            ...
            entity.HasOne(d => d.KhachHang)
                .WithMany(p => p.ThamGiaMuaChungs) // nếu có ICollection trong KhachHang
                .HasForeignKey(d => d.MaKh)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("FK_ThamGiaMuaChung_KhachHang");

            entity.HasOne(d => d.GiamGia)
                .WithMany(p => p.ThamGiaMuaChungs) // nếu có ICollection trong GiamGia
                .HasForeignKey(d => d.MaGG)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("FK_ThamGiaMuaChung_GiamGia");
        });
