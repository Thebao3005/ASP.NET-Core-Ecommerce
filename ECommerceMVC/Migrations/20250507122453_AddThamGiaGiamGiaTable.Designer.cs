...
{
    [DbContext(typeof(MuaChungContext))]
    [Migration("20250507122453_AddThamGiaGiamGiaTable")]
    partial class AddThamGiaGiamGiaTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceMVC.Models.GiamGia", b =>
                {
                    b.Property<int>("MaGG")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaGG"));
            ...
            modelBuilder.Entity("ECommerceMVC.Models.ThamGiaGiamGia", b =>
                {
            ...
            modelBuilder.Entity("ECommerceMVC.Data.HoiDap", b =>
                {
                    ...
                    b.HasOne("ECommerceMVC.Data.YeuThich", "MaYtNavigation")
                        .WithMany("HoiDaps")
                        .HasForeignKey("MaYt")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ECommerceMVC.Models.ThamGiaGiamGia", b =>
                {
                    b.HasOne("ECommerceMVC.Models.GiamGia", "GiamGia")
                        .WithMany()
                        .HasForeignKey("MaGG")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
