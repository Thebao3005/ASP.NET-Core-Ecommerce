...
{
    /// <inheritdoc />
    public partial class AddThamGiaGiamGiaTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgaySinh = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoTa = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsGiamGia = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    MaNCC = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaGG = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaHH = table.Column<int>(type: "int", nullable: false),
                    TyLeGG = table.Column<int>(type: "int", nullable: false),
                    NguoiToiThieu = table.Column<int>(type: "int", nullable: false),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SoNguoiThamGia = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoSao = table.Column<int>(type: "int", nullable: true, defaultValue: 5),
                    Comment = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    AnDanh = table.Column<bool>(type: "bit", nullable: true, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThamGiaGiamGias", x => x.MaThamGia);
                    table.ForeignKey(
                        name: "FK_ThamGiaGiamGias_GiamGia_MaGG",
                        column: x => x.MaGG,
                        principalTable: "GiamGia",
                        principalColumn: "MaGG",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ThamGiaGiamGias_KhachHang_MaKh",
                        column: x => x.MaKh,
                        principalTable: "KhachHang",
                        principalColumn: "MaKH",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgayDua = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                    MaNV = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HoiDap_YeuThich",
                        column: x => x.MaYT,
                        principalTable: "YeuThich",
                        principalColumn: "MaYT",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThamGiaGiamGias_MaGG",
                table: "ThamGiaGiamGias",
                column: "MaGG");

            migrationBuilder.CreateIndex(
                name: "IX_ThamGiaGiamGias_MaKh",
                table: "ThamGiaGiamGias",
                column: "MaKh");

            migrationBuilder.CreateIndex(
                name: "IX_YeuThich_MaHD",
                table: "YeuThich",
                column: "MaHD");
